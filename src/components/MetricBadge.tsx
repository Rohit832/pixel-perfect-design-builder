...
const MetricBadge: React.FC<MetricBadgeProps> = ({ icon, label, variant = 'decrease' }) => {
  return (
    <div className="flex justify-center items-center gap-1 bg-[rgba(56,120,109,0.10)] p-[3px] rounded-[30px] transition-all duration-200 hover:bg-[rgba(56,120,109,0.15)]">
      <div>
        <div
